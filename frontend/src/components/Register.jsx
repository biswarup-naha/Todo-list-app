    ...
    return (
        <div className="flex items-center justify-center min-h-screen text-white">
            <div className="p-8 rounded-2xl shadow-2xl text-center w-96">
                ...
                <input type="name" placeholder="Name" className="w-full p-3 rounded-md  mb-3 focus:outline-none" />
                ...
                <button className="w-full py-3 mt-3 bg-purple-600 hover:bg-purple-700 rounded-md transition-all">Sign Up</button>
                <p className="mt-4 text-sm">Already have an account? <span className="text-purple-400 hover:underline cursor-pointer" onClick={()=>setIsLogin(true)}>Login</span></p>
            </div>
        </div>
    );
}
